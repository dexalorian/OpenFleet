<template>
    ...
    <div class="h-full justify-center w-full items-center flex flex-col text-xs text-left">
        ...
        <div class="text-left py-4 px-4 flex flex-col w-full gap-2">
            <!-- {{ vehicle.currentGeo.value.lat }} -->
              {{ options }}
            <!-- <div class="flex w-full gap-2">
                <div class="flex flex-col w-full gap-1">
                    <Label for="lat">Latittude</Label>
                    <Input :value="vehicle.currentGeo.value?.lat" id="lat" class="w-full flex" />
                </div>
                <div class="flex flex-col w-full gap-1">
                    <Label for="lng">Longitude</Label>
                    <Input :value="vehicle.currentGeo.value?.lng"  id="lng" class="w-full flex" />
                </div>
            </div> -->
                ...
                <div class="flex items-center gap-2">
                    ...
                    <Switch  id="debug_geo"/>
                    <Label for="debug_geo" class="space">Use debugfdfdfd values</Label>
                </div>
